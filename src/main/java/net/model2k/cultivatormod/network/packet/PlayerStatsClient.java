...
public class PlayerStatsClient {
    ...
    private static int spiritPower = 10;
    ...
    public static void setQi(int qiVal) {
        qi = qiVal;
    }

    public static void setMaxQi(int maxVal) {
        maxQi = maxVal;
    }
    ...
    public static void setMaxSpiritPower(int maxSpiritPower) {
        PlayerStatsClient.maxSpiritPower = maxSpiritPower;
    }
    ...
    public static void setSpiritPower(int spiritPower) {
        PlayerStatsClient.spiritPower = spiritPower;
    }
}