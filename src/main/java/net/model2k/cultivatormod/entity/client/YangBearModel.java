...
public class YangBearModel extends HierarchicalModel<YangBearEntity> {
    ...
    public YangBearModel(ModelPart root) {
        ...
        ModelPart frontLeftLeg = this.Bear.getChild("FrontLeftLeg");
        ModelPart backLeftLeg = this.Bear.getChild("BackLeftLeg");
        ModelPart backRightLeg = this.Bear.getChild("BackRightLeg");
        ModelPart frontRightLeg = this.Bear.getChild("FrontRightLeg");
        ModelPart tail = this.Bear.getChild("Tail");
        ModelPart neck = this.Bear.getChild("Neck");
